...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      // It return fail if the name contain space.
    },
    slug: String,
    duration: {
      type: Number,
    ...
    priceDiscount: {
      ...
      validate: {
        validator: function (val) {
          // this only work in create new tour, not update tour.
...
// >>>>>>>>> Embedding the guides users into the tours. >>>>>>>>>>
...
tourSchema.pre('aggregate', function (next) {
  ...
  // If the first stage is $geoNear, insert $match after it
