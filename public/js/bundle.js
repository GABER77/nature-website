...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  var points = locations.map(function (_ref) {
    ...
    var _coordinates = _slicedToArray(coordinates, 2),
      lng = _coordinates[0],
      lat = _coordinates[1];
    L.marker([lat, lng]).addTo(map).bindTooltip("<p style=\"font-size: 10px;\">Day ".concat(day, ": ").concat(description, "</p>"), {
      permanent: true,
      direction: 'top',
      offset: [-14, -14]
    });
...
const VERSION = exports.VERSION = "1.8.1";
  ...
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          // 'true' will reload the page from the server, not from the cache
...
if (map) {
  (0, _leaflet.displayMap)(JSON.parse(map.dataset.locations));
}
